...
The Workload Provider must not trust the Orchestration Operator or Cloud Operator otherwise 
they risk losing the trust of the Data Owner. This means the Workload Provider must
provide assurance to the data owner regarding the integrity of the code and that the data is 
...
*deprivilege orchestration* and put a persona inside the TEE boundary in control of the 
